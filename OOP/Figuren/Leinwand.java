...
public class Leinwand {
  ...
  /**
   * Es wird ein Raster mit 20 Pixel-Abstand in hellgrau gezeichnet,
   * falls die Variable raster true ist.
   */
  private void zeichneRaster()
  {
    ...
    Dimension size = zeichenflaeche.getSize();
    for (int xi=0; xi<size.width; xi += 20) {
       for (int yi=0; yi<size.height; yi += 20) {
          graphic.draw(new Rectangle(xi, yi, xi+20, yi+20));
       }
    }
    graphic.setColor(original);      
  }
